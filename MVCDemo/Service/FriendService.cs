    ...
    public class FriendService
    {
        ...
        static FriendService()
        {
            Friends = new List<Friend>
                {
                    new Friend { FriendId = 1, FriendName = "Vishwa", Place="Belgaum" },
                    new Friend { FriendId = 2, FriendName = "Ram", Place="Kolar" },
                    new Friend {FriendId = 3, FriendName = "Arun", Place="Ballari" }
                };
        }
